...
def main(**options):
    ...
    print "calculating shock using code {0}".format(options["name_of_the_code"])
    ...
    store_attributes(xpositions,rho,u,p,
        filename="exact_riemann_shock_tube_problem_{0}.csv".format(model.name_of_the_code))
    store_attributes(samples.x,samples.rho,samples.rhovx,samples.energy,
        filename="riemann_shock_tube_problem_{0}.csv".format(model.name_of_the_code))
